    ...
    <header class="container"> 
        <div class="row" style="background-color:black">
            ...
            <div class="col-lg-6 text-right">
                <a href="adminposts.php" class="menu" style="color:white" ><?php echo "Admin Posts" ?></a>
                <a href="allposts.php" class="menu" style="color:white" ><?php echo "All Posts" ?></a>
                ...
                foreach($islem as $row){
                    echo '<div class="col-lg-4">
                        <div class="card">
                            ...
                            <a href="yaziadmin.php?link='.$row["yazi_link"].'" class="btn btn-dark">Read more</a>
                            </div>
                        </div>
                    </div>';
                }
