    ...
    <header class="container"> 
        <div class="row" style="background-color:black">
            ...
            <div class="col-lg-6" style="text-align: right">
                <a href="welcome.php" class="logo"><strong><h3 style="color:white; ">Go Back</h3></strong></a>
            </div>
        </div>
    </header>
    ...
    <div class="container">
        <div class="row">
            ...
            <strong>Username:</strong> <?php echo $uname; ?>
                ...
                <a href="yazi.php?link=<?php echo $link; ?>" class="link"><h1 class="text-center"><strong><?php echo $ttle; ?></strong></h1></a>
