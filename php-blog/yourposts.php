...
<body>
    <header class="container"> 
        <div class="row" style="background-color:black">
            ...
            <div class="col-lg-6 text-right">
                <a href="yourposts.php" class="menu" style="color:white" ><?php echo "EDIT: ".$_SESSION['username']."" ?></a>
    ...
    <div class="container">
        ...
        <div class="row">
            <?php
                $sql = "SELECT * FROM yazilar where status='approved' AND username ='".$_SESSION['username']."'";
                        ...
                        foreach($result as $row){
                            echo '<div class="col-lg-4">
                                <div class="card">
                                    ...
                                    <a href="edit.php?id='.$row["yazi_id"].'" class="btn btn-dark">Edit</a>
                                    <a href="delete.php?id='.$row["yazi_id"].'" class="btn btn-dark">Delete</a>
                                    </div>
                                </div>
                            </div>';
                        }
